 ...
 */
 metadata {
 	definition (name: "Wemo Light Switch", namespace: "mujica", author: "SmartThings") {
        capability "Actuator"
        capability "Switch"
        capability "Polling"
        capability "Refresh"
...
def refresh() {
    ...
    log.debug "{parent.settings.interval}"
 	//parent.sync()
    //, poll()
    [subscribe()]
}
...
log.debug "Executing 'subscribe(${hostAddress},${address})'"
